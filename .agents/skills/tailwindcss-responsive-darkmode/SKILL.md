...
<section class="py-8 md:py-12 lg:py-16 px-4 md:px-8 lg:px-12">
  <div class="max-w-4xl mx-auto">Content with responsive padding</div>
</section>
```
...
"
>
  <div class="hidden dark:md:block">Only visible on md+ screens in dark mode</div>
</div>
```
...
<a href="#" class="block py-3 px-4 min-h-11"> Navigation Item </a>
...
<nav class="fixed bottom-0 inset-x-0 safe-area-pb bg-white border-t">Navigation</nav>
```
