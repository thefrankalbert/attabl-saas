-- ============================================================================
-- ATTABL - schema of record (generated snapshot)
-- ============================================================================
-- Full public-schema DDL of the production database (tables, RLS policies,
-- functions, indexes, constraints). Schema only - NO row data.
--
-- Purpose: the base schema of the core tables was historically unversioned
-- (migrations only ALTER existing tables). This snapshot documents the real
-- schema in the repo so it can be reviewed, diffed for drift, and used to
-- provision a fresh database.
--
-- This file is NOT part of the migration replay stream (it would conflict with
-- the existing applied migrations on prod). Regenerate after schema changes:
...
CREATE POLICY "Admins can manage announcements" ON "public"."announcements" USING (("tenant_id" IN ( SELECT "public"."get_my_tenant_ids"() AS "get_my_tenant_ids")));



CREATE POLICY "Admins can manage own tenant admins" ON "public"."admin_users" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant categories" ON "public"."categories" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant coupons" ON "public"."coupons" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant ingredients" ON "public"."ingredients" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant item_suggestions" ON "public"."item_suggestions" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));
...
CREATE POLICY "Admins can manage own tenant menus" ON "public"."menus" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant orders" ON "public"."orders" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant recipes" ON "public"."recipes" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant stock_movements" ON "public"."stock_movements" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant suppliers" ON "public"."suppliers" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage own tenant venues" ON "public"."venues" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage price variants" ON "public"."item_price_variants" USING (("tenant_id" = ANY ("public"."get_my_tenant_ids_array"())));



CREATE POLICY "Admins can manage tables" ON "public"."tables" USING (("tenant_id" IN ( SELECT "public"."get_my_tenant_ids"() AS "get_my_tenant_ids")));
...
CREATE POLICY "Admins can manage zones" ON "public"."zones" USING (("tenant_id" IN ( SELECT "public"."get_my_tenant_ids"() AS "get_my_tenant_ids")));
...
CREATE POLICY "Coupons manageable by admins" ON "public"."coupons" USING (("tenant_id" IN ( SELECT "public"."get_my_tenant_ids"() AS "get_my_tenant_ids")));
...
CREATE POLICY "Item modifiers manageable by admins" ON "public"."item_modifiers" USING (("tenant_id" IN ( SELECT "public"."get_my_tenant_ids"() AS "get_my_tenant_ids")));



CREATE POLICY "Item modifiers viewable by public" ON "public"."item_modifiers" FOR SELECT USING (true);
...
CREATE POLICY "Public can view item options" ON "public"."item_options" FOR SELECT USING (true);



CREATE POLICY "Public can view price variants" ON "public"."item_price_variants" FOR SELECT USING (true);
...
CREATE POLICY "service_role_full_access" ON "public"."restaurant_groups" USING (("auth"."role"() = 'service_role'::"text"));
...
GRANT ALL ON FUNCTION "public"."adjust_ingredient_stock"("p_tenant_id" "uuid", "p_ingredient_id" "uuid", "p_delta" numeric) TO "anon";
...
GRANT ALL ON FUNCTION "public"."claim_coupon_usage"("p_coupon_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_daily_revenue"("p_tenant_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_order_summary"("p_tenant_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_owner_dashboard"("p_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_stock_status"("p_tenant_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_top_items"("p_tenant_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_limit" integer) TO "anon";
...
GRANT ALL ON FUNCTION "public"."increment_login_count"("admin_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."provision_signup_tenant"("p_slug" "text", "p_name" "text", "p_plan" "text", "p_user_id" "uuid", "p_email" "text", "p_full_name" "text", "p_phone" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."provision_signup_tenant"("p_slug" "text", "p_name" "text", "p_plan" "text", "p_user_id" "uuid", "p_email" "text", "p_full_name" "text", "p_phone" "text") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."set_opening_stock"("p_tenant_id" "uuid", "p_ingredient_id" "uuid", "p_quantity" numeric) TO "anon";
...
GRANT ALL ON FUNCTION "public"."unclaim_coupon_usage"("p_coupon_id" "uuid") TO "anon";
