                ...
                <div className="p-4 space-y-4">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <span className={`font-medium ${language === 'fr' ? 'text-gray-900' : 'text-gray-500'}`}>Français</span>
                        </div>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <span className="text-2xl">🇬🇧</span>
                            <span className={`font-medium ${language === 'en' ? 'text-gray-900' : 'text-gray-500'}`}>English</span>
                        </div>
