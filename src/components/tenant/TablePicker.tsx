...
export default function TablePicker({ isOpen, onClose, onSelect, zones, tables }: TablePickerProps) {
    ...
    const availableTables = useMemo(() => {
        ...
        return tables.filter(t => t.zone_id === selectedZone.id).sort((a, b) => a.table_number.localeCompare(b.table_number, undefined, { numeric: true }));
    }, [selectedZone, tables]);
                ...
                <div className="p-6">
                    <div className="flex gap-4 h-64">
                        ...
                        <div className="flex-1 flex flex-col">
                            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 text-center">Zone</label>
                            <div className="flex-1 overflow-y-auto pr-1 space-y-1">
                                ...
                                {zones.length === 0 && <p className="text-xs text-gray-400 text-center py-4">Aucune zone</p>}
                            </div>
                        </div>
                        ...
                        {/* Table Column */}
                        <div className="flex-1 flex flex-col">
                            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 text-center">Table</label>
