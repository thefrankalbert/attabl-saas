    ...
    <TabsContent value="security" className="mt-0">
      <div className="bg-app-card rounded-xl border border-app-border p-4 sm:p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-app-text">{t('idleLock')}</h2>
            <p className="text-sm text-app-text-secondary">{t('autoLockDashboard')}</p>
          </div>
        </div>

        <div className="space-y-4">
          {/* Enable/disable toggle */}
          <div className="flex items-center justify-between p-4 rounded-lg border border-app-border bg-app-elevated">
            <div>
