          ...
          <div className="mx-auto w-full max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                {/* Logo Upload */}
                <div className="mb-4">
                  <Label className="mb-2 flex items-center gap-2 text-xs font-medium text-app-text-secondary">
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      ...
                      className="relative w-28 h-28 shrink-0 flex flex-col items-center justify-center overflow-hidden cursor-pointer rounded-lg border border-app-border bg-app-elevated shadow-sm transition-all duration-150 hover:border-app-border-hover hover:bg-app-hover"
                    >
                      {data.logoUrl ? (
                        <>
                          <img
                    ...
                    {colorPresets.map((preset) => {
                      ...
                      return (
                        <Button
                          ...
                          className={`flex h-auto flex-col items-center gap-1 rounded-lg p-1.5 transition-all duration-150 ${
                            isSelected
