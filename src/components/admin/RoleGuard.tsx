  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
      <div className="p-4 bg-neutral-100 rounded-2xl mb-4">
        <ShieldX className="w-8 h-8 text-neutral-400" />
      </div>
      <h2 className="text-lg font-semibold text-neutral-900 mb-1">{t('accessDenied')}</h2>
      <p className="text-sm text-neutral-500 max-w-sm">{t('ownerOnly')}</p>
    </div>
  );
}
