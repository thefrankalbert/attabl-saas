    ...
    <>
      ...
      <AnimatePresence>
        {isLocked && (
          ...
          >
            {/* Backdrop */}
            <div className="absolute inset-0 bg-app-bg/98 backdrop-blur-xl" />
            ...
            >
              ...
              <motion.div
                ...
                className="mb-8"
              >
                <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-accent-muted ring-1 ring-accent/20">
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className="bg-app-elevated rounded-lg p-1.5">
                  <svg
                ...
                <span className="text-sm font-bold tracking-tight text-app-text-muted">ATTABL</span>
              </div>
              ...
              {mode === 'overlay' ? (
                ...
                <form onSubmit={handlePasswordUnlock} className="w-full max-w-xs space-y-4">
                  <div className="space-y-1.5">
                    <div className="text-left text-xs text-app-text-muted mb-1">{userEmail}</div>
                    <div className="relative">
                      <Input
                        ...
                        required
                        autoFocus
                        className="h-12 pr-12 bg-app-elevated border-app-border text-app-text placeholder:text-app-text-muted focus:border-accent/50 focus:ring-accent/20 rounded-lg"
                      />
                      <button
                        type="button"
