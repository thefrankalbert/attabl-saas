  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-5 p-4 sm:p-6 pb-12 xl:h-full xl:overflow-hidden xl:pb-4 animate-pulse">
        ...
        {/* Main Grid */}
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] 2xl:grid-cols-[minmax(0,1fr)_360px] gap-4 flex-1 min-h-0">
          <div className="flex flex-col gap-4">
            <div className="h-[220px] xl:h-[300px] bg-app-elevated/30 rounded-xl border border-app-border/50" />
            <div className="h-[240px] bg-app-elevated/30 rounded-xl border border-app-border/50" />
          </div>
          <div className="min-h-[240px] xl:h-full bg-app-elevated/30 rounded-xl border border-app-border/50" />
        </div>
      </div>
    );
  }
