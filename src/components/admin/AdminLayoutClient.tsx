  ...
  return (
    <div className="h-dvh overflow-hidden flex flex-col bg-app-bg transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:top-2 focus:left-2 focus:rounded-md focus:bg-white focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:shadow-lg"
        >
          Skip to content
        </a>
