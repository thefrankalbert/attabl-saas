    ...
    <div className="flex items-center gap-3 p-3 bg-app-bg rounded-lg hover:bg-app-bg/80 transition-colors group/item">
      ...
      {editingPriceId === item.id ? (
        <Input
          ref={priceInputRef}
          type="number"
          className="w-24 text-base md:text-sm font-bold text-app-text tabular-nums bg-app-card border border-app-border rounded px-2 py-0.5 text-right focus:outline-none focus:ring-1 focus:ring-accent/30 h-auto shadow-none"
