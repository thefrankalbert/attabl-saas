 ...
 * Matches mockup Dashboard.html lines 103-110 / 541-547.
 */
export function SidebarUsageCard({ label, percent, subtitle }: SidebarUsageCardProps) {
  const clamped = Math.max(0, Math.min(100, Math.round(percent)));

  return (
    <div className="rounded-lg border border-app-border bg-app-elevated px-3 py-2.5">
