...
export function useServiceLabels() {
  ...
  const detailLabels = useMemo(
    () => ({
      ...
      orderTotal: tc('total'),
      moveTableBtn: t('moveTableBtn'),
      reassignTitle: t('reassignTitle'),
      reassignDescription: t('reassignDescription'),
      reassignPlaceholder: t('reassignPlaceholder'),
      reassignNoFreeTables: t('reassignNoFreeTables'),
      reassignConfirm: t('reassignConfirm'),
      reassignCancel: tc('cancel'),
      reassignMoving: t('reassignMoving'),
      reassignSuccess: t('reassignSuccess'),
      reassignError: t('reassignError'),
    }),
    [t, tc],
  );
