  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-wrap">
        ...
        <span className={`font-normal ${styleConfig.textClass}`}>{message}</span>
        <Link
          href={upgradeUrl}
          className={`inline-flex items-center gap-1 font-bold whitespace-nowrap hover:underline ${styleConfig.linkClass}`}
        >
          {t('upgradeToPremium')}
