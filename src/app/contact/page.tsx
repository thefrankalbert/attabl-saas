                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto p-6 flex flex-col h-full">
                            <nav className="flex flex-col gap-2 text-2xl font-bold">
                                <Link href="/" onClick={closeMobileMenu} className="p-4 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 text-gray-900 dark:text-white">Accueil</Link>
                                <Link href="/#features" onClick={closeMobileMenu} className="p-4 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 text-gray-900 dark:text-white">Fonctionnalités</Link>
                                <Link href="/#pricing" onClick={closeMobileMenu} className="p-4 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 text-gray-900 dark:text-white">Tarifs</Link>
                                <Link href="/contact" onClick={closeMobileMenu} className="p-4 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 text-[#CCFF00]">Contact</Link>
                            </nav>
                            ...
                            <div className="flex flex-col gap-4 mt-auto pb-8">
                                <div className="flex justify-between items-center px-4">
                                    ...
                                    <button onClick={toggleTheme} className="h-10 w-10 flex items-center justify-center rounded-full bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white">
                                        {theme === 'dark' ? <Sun className="h-5 w-5" /> : <Moon className="h-5 w-5" />}
                                    </button>
                                </div>
                                <div className="h-4"></div>
                                <Link href="/login" onClick={closeMobileMenu}>
                                    <Button variant="ghost" className="w-full justify-center text-lg h-14 rounded-xl border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white">Connexion</Button>
                                </Link>
                            </div>
                        </div>
                    </motion.div>
            ...
            <header className="fixed top-0 z-50 w-full bg-white/80 dark:bg-black/80 backdrop-blur-md py-4 border-b border-gray-100 dark:border-white/5">
                <div className="container mx-auto px-6 max-w-7xl flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex items-center gap-10 text-sm font-medium text-gray-500 dark:text-gray-400">
                        ...
                        <Link href="/#features" className="hover:text-black dark:hover:text-white transition-colors">Fonctionnalités</Link>
                        <Link href="/contact" className="text-black dark:text-white font-bold">Contact</Link>
                    </nav>
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        ...
                        <Link href="/login">
                            <Button variant="ghost" className="rounded-full text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-white/5 font-semibold">Connexion</Button>
                        </Link>
                    </div>

                    <button className="md:hidden p-2 text-black dark:text-white" onClick={() => setMobileMenuOpen(true)}>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Email</p>
                                    <a href="mailto:contact@attabl.com" className="text-lg font-bold text-gray-900 dark:text-white hover:text-[#CCFF00] transition-colors">contact@attabl.com</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Disponibilité</p>
                                    <p className="text-lg font-bold text-gray-900 dark:text-white">Lun - Ven, 9h - 18h</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        <div className="relative bg-white dark:bg-[#0A0A0A] border border-gray-200 dark:border-white/10 p-8 md:p-10 rounded-3xl shadow-xl">
                            ...
                            {formState.success ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Demande Envoyée !</h3>
                                ...
                                <form action={formAction} className="flex flex-col gap-6">
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label htmlFor="name" className="text-sm font-bold text-gray-900 dark:text-white">Nom complet</label>
                                            <input
                                                type="text"
                                                name="name"
                                                id="name"
                                            ...
                                            />
                                            {formState.errors?.name && <p className="text-red-500 text-xs">{formState.errors.name[0]}</p>}
                                        </div>
                                        <div className="space-y-2">
                                            <label htmlFor="company" className="text-sm font-bold text-gray-900 dark:text-white">Établissement</label>
                                            <input
                                                type="text"
                                                name="company"
                                                id="company"
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-sm font-bold text-gray-900 dark:text-white">Email professionnel</label>
                                        <input
                                            type="email"
                                            name="email"
                                            id="email"
                                            ...
                                            className="w-full h-12 px-4 rounded-xl bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-white/10 focus:ring-2 focus:ring-[#CCFF00] focus:border-transparent focus:outline-none transition-all"
                                        />
                                        {formState.errors?.email && <p className="text-red-500 text-xs">{formState.errors.email[0]}</p>}
                                    </div>

                                    <div className="space-y-2">
                                        <label htmlFor="date" className="text-sm font-bold text-gray-900 dark:text-white">Préférence de date/heure (Optionnel)</label>
                                        <input
                                            type="text"
                                            name="date"
                                            id="date"
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="message" className="text-sm font-bold text-gray-900 dark:text-white">Message / Besoins spécifiques</label>
                                        <textarea
                                            name="message"
                                            id="message"
                                            rows={4}
                                        ...
                                        ></textarea>
                                        {formState.errors?.message && <p className="text-red-500 text-xs">{formState.errors.message[0]}</p>}
                                    </div>
