  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-neutral max-w-none space-y-6 text-neutral-600">
        ...
        <h2 className="text-xl font-semibold text-neutral-900 mt-8">1. Objet</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-neutral-900 mt-8">2. Acc&egrave;s au service</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-neutral-900 mt-8">3. Abonnements et tarifs</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-neutral-900 mt-8">5. Contact</h2>
        <p>
