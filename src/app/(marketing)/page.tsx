...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white font-sans selection:bg-[#CCFF00] selection:text-black overflow-x-hidden transition-colors duration-300">
      ...
      <section className="py-32 bg-white dark:bg-black border-t border-gray-100 dark:border-white/5 relative overflow-hidden">
        {/* Background Elements */}
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32">
                ...
                <Button variant="outline" className="border-gray-200 dark:border-white/10 hover:border-[#CCFF00] hover:text-[#CCFF00] rounded-full h-12 px-8">
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
              {t.testimonials.reviews.map((review, i) => (
                <motion.div
                  ...
                  className={`p-8 rounded-[2rem] border transition-colors duration-300 hover:border-[#CCFF00]/50 group ${i % 2 === 0 ? 'md:mt-0' : 'md:mt-12' /* Staggered effect */
                    } ${theme === 'light' ? 'bg-gray-50 border-gray-200 hover:bg-white hover:shadow-xl' : 'bg-[#0A0A0A] border-white/10 hover:bg-[#121212]'
                    }`}
                >
                  <Quote className="h-8 w-8 text-[#CCFF00] mb-6 opacity-50 group-hover:opacity-100 transition-opacity" />
                  <p className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-8 leading-relaxed">
                    "{review.text}"
                  </p>
      ...
      {/* PRICING */}
      <section id="pricing" className="py-32 bg-gray-50 dark:bg-[#050505] relative transition-colors duration-300 border-t border-gray-100 dark:border-white/5">
