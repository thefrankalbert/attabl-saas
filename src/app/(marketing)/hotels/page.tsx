      ...
      <section className="py-20 lg:py-28 bg-white dark:bg-neutral-950">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-[family-name:var(--font-sora)] text-4xl sm:text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-white tracking-tight">
            {'Un hôtel. Plusieurs restaurants. Une seule plateforme.'}
          </h1>
          <p className="text-lg sm:text-xl text-neutral-500 dark:text-neutral-400 max-w-2xl mx-auto mt-6">
            {
              'Room service, bar, restaurant - vos clients commandent dans leur langue, vous gérez tout au même endroit.'
            }
          </p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                icon: Hotel,
                title: 'Chambre par chambre',
                description:
                  'QR code unique par chambre. Le client commande depuis son lit, dans sa langue. Zéro appel à la réception.',
              },
              {
                icon: Building2,
                title: 'Tout sous un toit',
                description:
                  'Restaurant, bar lounge, piscine, room service. Un seul dashboard pour tout piloter.',
              },
              {
                icon: Globe,
                title: 'Accueillez le monde',
                description:
                  'Menu en français, anglais, et plus. Paiement en XAF, EUR, USD. Vos clients internationaux se sentent chez eux.',
              },
            ].map((feature) => (
              <div
                key={feature.title}
      ...
      <section className="py-20 bg-white dark:bg-neutral-950">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-[family-name:var(--font-sora)] text-3xl sm:text-4xl font-bold text-neutral-900 dark:text-white">
            Vos clients viennent de partout. Votre service doit suivre.
          </h2>
