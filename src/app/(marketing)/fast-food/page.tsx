      ...
      <section className="py-20 lg:py-28 bg-white dark:bg-neutral-950">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-500 dark:text-neutral-400 max-w-2xl mx-auto mt-6">
            {'Écran cuisine, stock centralise. La vitesse a grande échelle.'}
          </p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                icon: MonitorCheck,
                title: 'Dashboard multi-sites',
                description:
                  'Performances de chaque point de vente en temps réel. Comparez, identifiez, optimisez.',
              },
              {
                icon: Smartphone,
              ...
              },
              {
                ...
                description:
                  'Approvisionnement centralisé pour tous vos points de vente. Alertes par site, par ingrédient.',
              },
            ].map((feature) => (
              <div
                key={feature.title}
      ...
      <section className="py-20 bg-white dark:bg-neutral-950">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-[family-name:var(--font-sora)] text-3xl sm:text-4xl font-bold text-neutral-900 dark:text-white">
            Grandissez sans perdre le contrôle.
          </h2>
