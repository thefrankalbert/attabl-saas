      ...
      <section className="py-20 lg:py-28 bg-white dark:bg-neutral-950">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-[family-name:var(--font-sora)] text-4xl sm:text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-white tracking-tight">
            Votre comptoir. Votre terrasse. Tout sous contrôle.
          </h1>
          <p className="text-lg sm:text-xl text-neutral-500 dark:text-neutral-400 max-w-2xl mx-auto mt-6">
            Carte cocktails, service terrasse, stock de boissons - tout en un.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                icon: QrCode,
                title: 'Menu QR terrasse',
                description:
                  'Le client scanne depuis sa table, commande sans attendre le serveur. Plus de va-et-vient inutile.',
              },
              {
                icon: Coffee,
                title: 'Suivi boissons',
                description:
                  'Chaque verre servi est déduit du stock. Vous voyez le coulage en temps réel. Fini les pertes invisibles.',
              },
              {
                icon: Clock,
                title: 'Best-sellers en direct',
                description:
                  'Quels cocktails marchent ce soir ? Quelles bières stagnent ? Ajustez votre carte en temps réel.',
              },
            ].map((feature) => (
              <div
                key={feature.title}
      ...
      <section className="py-20 bg-white dark:bg-neutral-950">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-[family-name:var(--font-sora)] text-3xl sm:text-4xl font-bold text-neutral-900 dark:text-white">
            {"Votre bar mérite mieux qu'un tableur."}
          </h2>
