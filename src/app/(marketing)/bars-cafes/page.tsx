    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Fluidifiez votre service avec un menu digital adapté au rythme de votre bar ou café.
          </motion.p>
          <Link
            href="/signup"
            ...
            {[
              {
                ...
                title: 'Menu QR code',
                description:
                  'Vos clients scannent, consultent et commandent directement depuis leur table. Plus de files d&apos;attente au comptoir.',
              },
              {
                icon: Coffee,
                title: 'Modifiers illimités',
                description:
                  'Lait d&apos;amande, double expresso, glaçons, sans sucre : gérez toutes les personnalisations de vos boissons simplement.',
              },
              {
                icon: Clock,
                title: 'Happy hour automatique',
                description:
                  'Programmez vos offres par plage horaire. Cocktails à -50% de 18h à 20h : tout se calcule automatiquement.',
              },
            ].map((feature, idx) => (
              <motion.div
                key={feature.title}
