...
// Clés de stockage isolées pour Admin et Client (Namespace Attabl)
const STORAGE_KEYS = {
  admin: 'attabl_admin_prefs_lang',
...
const translations: Translations = {
  ...
  ingredients: { fr: 'Produits en stock', en: 'Ingredients' },
  recipes_tech: { fr: 'Fiches techniques', en: 'Recipes' },
  ...
  low_stock: { fr: 'Stock bas', en: 'Low stock' },
  stock_ok: { fr: 'Stock OK', en: 'Stock OK' },
  rupture: { fr: 'Rupture', en: 'Out of stock' },
  mark_rupture: { fr: 'Marquer en rupture', en: 'Mark as out of stock' },
  back_in_stock: { fr: 'Remettre en service', en: 'Back in stock' },
  opening_stock: { fr: "Stock d'ouverture", en: 'Opening stock' },
  ...
  alternative_item: { fr: 'Alternative', en: 'Alternative' },
  stock_live: { fr: 'Stock en direct', en: 'Live stock' },
  low_stock_alert: { fr: 'Alerte stock bas', en: 'Low stock alert' },
  ingredients_count: { fr: 'produits en stock', en: 'ingredients in stock' },
